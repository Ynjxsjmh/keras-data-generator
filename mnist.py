...
from generator import DataSequence, DataGenerator, data_generator
...
def fit_generator_class():
    ...
    #   This parameter is not supported when x is a dataset, generator or
    #   keras.utils.Sequence instance.
    model.fit(training_generator.data_generator(),
              steps_per_epoch=training_generator.steps,
              validation_data=validation_generator.data_generator(),
              validation_steps=validation_generator.steps,
              epochs=EPOCHS,
              verbose=VERBOSE)
